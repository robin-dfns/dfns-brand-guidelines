/* ============================================================
   ...
   ============================================================ */
(function () {
  var HOME = './';                         // Guidelines home (index.html)
  ...
  // key, label, hash — resolved against HOME.
  var GUIDE = [['brand', 'Brand', '#brand'], ['identity', 'Identity', '#identity'], ['assets', 'Assets', '#assets'], ['motion', 'Motion', '#motion']];
  ...
  var html = '' +
    ...
    '<div class="dsnav-links">' + links(HOME, GUIDE) + '</div>' +
